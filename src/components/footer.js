  ...
  const links3 = [
...

    {
      href: "/", text: <>
        ...
        <span className='  text-[15px]  font-semibold font-sans '>Research &amp; Developement <br />
          Center </span> <br />
        Street No. 7, Lane No.3A, Kadipur Rd <br />
        Kadipur Industrial Area, Sector 10A <br />
        ...
        <div className="grid-1 grid gap-2  md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5  text-center">
          ...
          <div className=' '>
            ...
            <div className="row flex w-full  rounded-full  justify-center    gap-3 cursor-pointer">
              ...
              <a href="https://twitter.com/AdhunikCooling" className="w-8 h-8 bg-white flex items-center justify-center rounded-full relative overflow-hidden group transition-all duration-300" aria-label="Visit our profile on X (formerly Twitter)">
              ...
              <a href="https://www.instagram.com/adhunikpowertech/" className="w-8 h-8 bg-white flex items-center justify-center rounded-full relative overflow-hidden group transition-all duration-500" aria-label="Visit our profile on Instagram">
              ...
              <a href="https://www.facebook.com/AdhunikPowertech/" className="w-8 h-8 bg-white flex items-center justify-center rounded-full relative overflow-hidden group transition-all duration-300" aria-label="Visit our profile on Facebook">
              ...
              <a href="https://www.youtube.com/channel/UCctav-6fJD60ZgQYydZOHLg" className="w-8 h-8 bg-white flex items-center justify-center rounded-full relative overflow-hidden group transition-all duration-300" aria-label="Visit our profile on YouTube">
              ...
              <a href="https://www.linkedin.com/company/14498324/" className="w-8 h-8 bg-white flex items-center justify-center rounded-full relative overflow-hidden group transition-all duration-300" aria-label="Visit our profile on YouTube">
