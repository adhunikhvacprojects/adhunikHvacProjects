  ...
  <p className=' font-semibold text-[15px]  font-sans  pb-1'>
          ...
          <div className=' '>
            ...
            <div className="row flex w-full md:justify-start  rounded-full  justify-center    gap-3 cursor-pointer">
              ...
              <a href="https://www.instagram.com/adhunikhvacprojects/" className="w-8 h-8 bg-white flex items-center justify-center rounded-full relative overflow-hidden group transition-all duration-500" aria-label="Visit our profile on Instagram">
              ...
              <a href="https://www.facebook.com/profile.php?id=61579836422988" className="w-8 h-8 bg-white flex items-center justify-center rounded-full relative overflow-hidden group transition-all duration-300" aria-label="Visit our profile on Facebook">
              ...
              <a href="https://www.youtube.com/channel/UCyt99nBc0JqY86wwWyekQmQ" className="w-8 h-8 bg-white flex items-center justify-center rounded-full relative overflow-hidden group transition-all duration-300" aria-label="Visit our profile on YouTube">
              ...
              <a href="https://www.linkedin.com/in/adhunik-hvac-projects-166698383/" className="w-8 h-8 bg-white flex items-center justify-center rounded-full relative overflow-hidden group transition-all duration-300" aria-label="Visit our profile on YouTube">
      ...
      <div className=" flex bg-black/5 p-6 text-center   flex-col  md:flex-row justify-center items-center gap-6">
        <div className="font-semibold cursor-pointer"  >© Copyright 2026 ADHUNIK HVAC PROJECTS Private Ltd. All Rights Reserved.</div>
