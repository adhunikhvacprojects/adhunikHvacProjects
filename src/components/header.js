    ...
    >
                    ...
                    <svg
                      onClick={() =>
                        (window.location.href =
                          "mailto:info@adhunikhvacproject.com")
                      }
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
      ...
      <div
        className={`mobile-menu xl:hidden  ${
          isMobileMenuOpen
            ? "mobile-menu-open py-2 bg-gray-100 text-black border-teal-300 border-b-[1px]"
            : "mobile-menu-closed"
        }`}
      >
        {isMobileMenuOpen &&
          links.map((link, index) => (
            <div
              key={index}
              className="mx-7 mb-2 border-b-[1px] border-teal-600 "
            >
              {link.dropdownItems ? (
                <div>
                  <div
                ...
                <Link
                  href={link.href || "/"}
                  className="block py-2 font-semibold px-4 text-sm hover:bg-gray-200"
