...
// Remove Tooltip import from flowbite-react
...
const WatsapButton = ({ phoneNumber }) => {
    ...
    return (
        <div className="relative group transition-all duration-500 hover:-translate-y-2"> {/* Add relative and group */}
            <div className="relative group/tooltip"> {/* Add relative and group/tooltip */}
                <button
            ...
            {/* The chat message box remains the same */}
